...
.red {
	...
	<div class="span10">
		...
		<?php } ?>
		<h2>Changelog v2.3.14</h2>
		<ul class="version-history">
			<li><span class="version-upgraded">Upg</span> Email attachments MIME types are now auto-detected.</li>
			<li><span class="version-upgraded">Upg</span> Bootstrap 4 auto-generated layout now uses 'col-md-' columns.</li>
			<li><span class="version-upgraded">Upg</span> 'Radio Group' and 'Checkbox Group' fields now show up as configured instead of dropdowns when editing a submission using the Directory.</li>
			<li><span class="version-upgraded">Upg</span> 'Return URL' can be configured based on form language.</li>
			<li><span class="version-fixed">Fix</span> File Uploads could be saved with an empty 'Destination' path.</li>
			<li><span class="version-fixed">Fix</span> File Uploads 'Show Image Preview' was not working when using a Uikit 3 layout.</li>
		</ul>
